        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <div class="card text-center border-0 shadow-sm">
                    <img src="{{ asset('storage/images/dmip.jpg') }}" class="card-img-top" alt="iPhone"
            ...
            <div class="col-md-4">
                <div class="card text-center border-0 shadow-sm">
                    <img src="{{ asset('storage/images/dmss.jpg') }}" class="card-img-top" alt="Samsung"
                        style="height: 200px; object-fit: cover;">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card text-center border-0 shadow-sm">
                    <img src="{{ asset('storage/images/dmxiao.jpg') }}" class="card-img-top" alt="Xiaomi"
                        style="height: 200px; object-fit: cover;">
                    <div class="card-body">
                ...
                <div class="col-md-3 mb-4">
                    <div class="card h-100 border-0 shadow-sm product-card">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <a href="{{ route('product.show', $product->id) }}" class="btn btn-primary mt-auto">Xem chi
                                tiết</a>
                        </div>
                    </div>
                </div>
...
@section('styles')
    <style>
        ...
        .toast-container {
            z-index: 1055;
            /* Đảm bảo toast nằm trên các phần tử khác */
        }
